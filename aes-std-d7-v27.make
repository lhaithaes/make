...
; to remove about to try easy_breadcrumb
...
; to remove but check token usage annd find alternative
projects[entityform][version] = "2.0-rc5"
; switching to embeded forms so this is to remove also check related modules
...
projects[file_entity][version] = "3.0-beta23"
...
; to remove we are about to use embeds
...
projects[upgrade_status][version] = "2.0-alpha3"
